...
possible_languages = read_possible_languages(abspath('applications', "Solapin"))
# ----------------------------------------------------------------------------------------------------------------------
...
routes_onerror = [
  ('Solapin/400', '/solapin/default/login'),
  ('Solapin/*', '/solapin/static/fail.html'),
  ('*/404', '/solapin/static/cantfind.html'),
  ('*/*', '/solapin/error/index')
]
# ----------------------------------------------------------------------------------------------------------------------
